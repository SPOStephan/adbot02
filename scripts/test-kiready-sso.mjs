...
assert.match(read("src/components/AuthForm.tsx"), /src="\/kiready-favicon-v2\.png"/);
assert.doesNotMatch(read("src/components/AuthForm.tsx"), />\s*KI\s*<\/span>/);
assert.ok(statSync(new URL("../public/kiready-favicon-v2.png", import.meta.url)).size > 1_000);
