...
assert.match(scrape, /ingested: false/);
...
assert.match(panel, /Freelance noch nicht kaufen|Freelance \(~50 USD\) erst nach Grün/);
assert.match(docs, /keine 50 USD/);
assert.match(docs, /Trial, 1000 Credits/);
assert.match(docs, /Unlocker-Probe #7341/);
assert.doesNotMatch(scrape, /probeChatGPTAdLibraryUnlocker[\s\S]{0,800}importChatGPTAdLibraryBatch/);
assert.match(panel, /Systemkatalog/);
