...
assert.match(contentSyncPanelSource, /Erkennungsrückschau/);
assert.match(contentSyncPanelSource, /erkannte-beitraege/);
...
assert.match(contentSyncSnapshotSource, /detectionHistory/);
assert.match(contentSyncSnapshotSource, /assetSyncHints/);
...
assert.doesNotMatch(callbackSource, /assigned_assets_invalid_parameter/);
