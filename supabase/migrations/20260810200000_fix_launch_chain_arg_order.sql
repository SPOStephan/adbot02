...
--
-- This migration replaces the customer daily materializer outright (no regexp
-- patch). Requires prior migrations:
--   20260810193000_ensure_launch_exposure_snapshot.sql
--   20260810194500_harden_launch_eur_snapshot_gate.sql
...
begin
  ...
  -- CORRECT order: platform_account_id first, user_id second (matches callee).
