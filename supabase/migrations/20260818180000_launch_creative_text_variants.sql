-- Launch creative: support Meta Dynamic Creative text variants via asset_feed_spec.
-- Multiple bodies/titles/descriptions on ONE ad (not multi-ad testing).
-- When asset_feed_spec is present: inject images + link_urls, strip link_data,
-- and force ad set is_dynamic_creative=true. Single-text launches unchanged.
