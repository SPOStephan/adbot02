-- Organic boost: optional Instagram media path + keep Facebook object_story_id.
-- Customers choose source_filter (facebook|instagram|both) and boost_mode (OFF|REVIEW|AUTO).
