...
- **SQL migrations:** When mentioning a Supabase/SQL migration, always include both the GitHub blob link and the raw link — do not wait to be asked. Always paste the **complete** SQL in chat (not a summary or truncated excerpt).
