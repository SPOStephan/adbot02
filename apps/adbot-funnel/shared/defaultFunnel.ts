...
export const defaultFunnel: FunnelConfig = {
  ...
  pages: [
    ...
    },
    {
      ...
      allowMultiple: false,
      options: [
        { id: "role-sales", label: "Vertrieb", value: "vertrieb", icon: "target", leadValue: 70, knockout: false, knockoutAction: "exit", handoffFunnelId: "" },
        { id: "role-office", label: "Office", value: "office", icon: "building", leadValue: 40, knockout: false, knockoutAction: "exit", handoffFunnelId: "" },
        { id: "role-tech", label: "Technik", value: "technik", icon: "rocket", leadValue: 55, knockout: false, knockoutAction: "exit", handoffFunnelId: "" },
        { id: "role-other", label: "Andere Rolle", value: "andere", icon: "sparkles", leadValue: 25, knockout: false, knockoutAction: "exit", handoffFunnelId: "" },
      ],
    },
    {
      id: "page-experience",
      ...
      allowMultiple: false,
      options: [
        { id: "exp-entry", label: "Ich starte gerade erst", value: "einstieg", icon: "graduation-cap", leadValue: 15, knockout: false, knockoutAction: "exit", handoffFunnelId: "" },
        { id: "exp-junior", label: "1–3 Jahre", value: "1-3", icon: "calendar", leadValue: 40, knockout: false, knockoutAction: "exit", handoffFunnelId: "" },
        { id: "exp-senior", label: "Mehr als 3 Jahre", value: "3-plus", icon: "star", leadValue: 80, knockout: false, knockoutAction: "exit", handoffFunnelId: "" },
        { id: "exp-change", label: "Ich bin Quereinsteiger:in", value: "quereinstieg", icon: "sparkles", leadValue: 35, knockout: false, knockoutAction: "exit", handoffFunnelId: "" },
      ],
    },
    {
      id: "page-contact",
