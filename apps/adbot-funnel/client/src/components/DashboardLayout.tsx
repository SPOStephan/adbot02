...
function DashboardLayoutContent({
  ...
  return (
    <>
      <a className="admin-skip-link" href="#admin-content">Zum Hauptinhalt springen</a>
      <div className="relative" ref={sidebarRef}>
          ...
          <SidebarFooter className="p-3">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button aria-label="Benutzermenü öffnen" className="flex items-center gap-3 rounded-lg px-1 py-1 hover:bg-accent/50 transition-colors w-full text-left group-data-[collapsible=icon]:justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-ring">
        ...
        <div
          ...
          aria-label="Breite der Navigation ändern"
      ...
      <SidebarInset>
        ...
        <main id="admin-content" tabIndex={-1} className="flex-1 p-4">{children}</main>
      </SidebarInset>
    </>
  );
}
