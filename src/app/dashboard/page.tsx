...
const META_ERROR_MESSAGES: Record<string, string> = {
  ...
  missing_ad_account_targets: "Meta hat keine Werbekonto-IDs geliefert und Adbot konnte das Werbekonto nicht eindeutig der gewählten Seite zuordnen. Ohne diese Auswahl speichert Adbot kein Werbekonto.",
