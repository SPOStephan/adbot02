...
export async function storePlatformLibraryAsset(input: {
  ...
  if (
    ...
    throw new Error("Platform library storage input is invalid");
  }
  ...
  if (error) {
    throw new Error("Platform library storage upload failed");
  }
